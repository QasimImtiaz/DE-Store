			...
			public void actionPerformed(ActionEvent arg0) {
				if(rdbtnStoreManager.isSelected()) {
					...
					if(emailAddressValidation == true && usernameValidation == true) {
						...
						JOptionPane.showMessageDialog(null, "You have successfully registered a account!");
						
					}
					else {
						JOptionPane.showMessageDialog(null, "Username or Email Address already exist!");
					}
				}
					...
					JOptionPane.showMessageDialog(null, "Please select whether you are a Store Manager or a Normal Employee!");
				}
			}
		});
