...
public class StockGUI extends JFrame {
	...
	public StockGUI() {
		...
		ArrayList<String> products = appLayer.produceMessages(); 
		for(int i = 2; i < products.size(); i = i + 3) {
			JOptionPane.showMessageDialog(null, "Warning: " + products.get(i-1) + "(" + products.get(i-2) + ") has only " + products.get(i) + " quantities left in stock!");
		}
